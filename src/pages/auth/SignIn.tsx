...
export const Foo = () =>{
  ...
  <section
    className="section"
    style={{
      background: "radial-gradient(circle at center, #3a1c5c 10%, #1a0b2e 90%)"
    }}
  >
          ...
          <div className="signup-container">
            ...
            <div className="social-login">
              <button className="btn">
                <img src="assets/imgs/gmail.png" alt="Google" /> Google
              </button>
              <button className="btn">
                <img src="assets/imgs/linkedin.png" alt="LinkedIn" /> LinkedIn
              </button>
            </div>
  ...
  style={{ position: "relative", background:" radial-gradient(circle at center, #3a1c5c 10%, #1a0b2e 90%)"}}>
      ...
      <div className="w-full max-w-md" style={{marginTop:"4em"}}>
        ...
        <div className="space-y-6">
          ...
          {/* <span className="position-absolute top-50 start-0 translate-middle-y ps-3"><i className="fa fa-envelope"></i></span> */}
            ...
            appearance={{
              ...
              variables: {
                default: {
                  colors: {
                    ...
                    inputBackground: "rgba(255, 255, 255,)",
                    inputText: "white",
              ...
              className: {
                ...
                anchor:
                  ...
                  input: "w-full pl-10 py-3 bg-white/[0.05] border border-white/10 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent relative",
              },
            }}
            providers={[]}
