...
const ForgotPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const redirectUrl = "https://golden-biscochitos-63bc22.netlify.app/auth/reset-password" ;
    ...
    return (
        <div style={{ position: "relative", background:" radial-gradient(circle at center, #3a1c5c 10%, #1a0b2e 90%)"}} className="min-h-screen bg-[#0B0F1A] flex items-center justify-center px-4 relative">
